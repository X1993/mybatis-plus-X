 ...
 * @date 2022/4/14
 */
public class SelectOneIgnoreLogical extends AbstractIgnoreLogicalMethod {

    @Override
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        IgnoreLogicalSqlMethod sqlMethod = IgnoreLogicalSqlMethod.SELECT_ONE_IGNORE_LOGICAL;
