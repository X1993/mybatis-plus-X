 ...
 * @date 2022/4/14
 */
public class SelectPageIgnoreLogical extends AbstractIgnoreLogicalMethod {

    public SelectPageIgnoreLogical()
    {
        super(IgnoreLogicalSqlMethod.SELECT_PAGE_IGNORE_LOGICAL.getMethod());
    }
     ...
     * @param name 方法名
     */
    public SelectPageIgnoreLogical(String name) {
        super(name);
    }

    @Override
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        IgnoreLogicalSqlMethod sqlMethod = IgnoreLogicalSqlMethod.SELECT_PAGE_IGNORE_LOGICAL;
