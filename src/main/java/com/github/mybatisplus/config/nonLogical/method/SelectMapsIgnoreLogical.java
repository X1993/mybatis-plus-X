 ...
 * @date 2022/4/14
 */
public class SelectMapsIgnoreLogical extends AbstractIgnoreLogicalMethod {

    @Override
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        IgnoreLogicalSqlMethod sqlMethod = IgnoreLogicalSqlMethod.SELECT_MAPS_IGNORE_LOGICAL;
