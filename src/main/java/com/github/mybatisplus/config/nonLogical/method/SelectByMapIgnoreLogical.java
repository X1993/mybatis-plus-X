...
/**
 * 根据columnMap 查询一条数据，忽略逻辑列配置
 *
 * 参考 {@link com.baomidou.mybatisplus.core.injector.methods.SelectByMap}
 *
 * @author X1993
 * @date 2022/4/14
 */
public class SelectByMapIgnoreLogical extends AbstractIgnoreLogicalMethod {

    @Override
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        IgnoreLogicalSqlMethod sqlMethod = IgnoreLogicalSqlMethod.SELECT_BY_MAP_IGNORE_LOGICAL;
