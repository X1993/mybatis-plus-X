 ...
 * @date 2022/4/14
 */
public class SelectBatchByIdsIgnoreLogical extends AbstractMethod {

    @Override
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        IgnoreLogicalSqlMethod sqlMethod = IgnoreLogicalSqlMethod.SELECT_BATCH_BY_IDS_IGNORE_LOGICAL;
